...
__BRYTHON__.compiled_date="2023-11-09 16:26:17.994264"
__BRYTHON__.timestamp=1699543577994
...
var state="line_start",char,cp,mo,pos=0,start,quote,triple_quote,escaped=false,string_start,string,prefix,name,operator,number,num_type,comment,indent,indents=[],braces=[],line,line_num=0,line_start=1,token_modes=['regular'],token_mode='regular',save_mode=token_mode,fstring_buffer,fstring_start,fstring_escape,format_specifier,nesting
...
if($B.get_option_from_filename('debug',url)> 1){console.log($B.format_indent(js,0))}}catch(err){	console.log('!',err);
...
$B.ast.Module.prototype.to_js=function(scopes){	console.log('scopes module',scopes);
mark_parents(this)
...
for(var key in docs){	const builtin=__BRYTHON__.builtins[key];
if(builtin && builtin instanceof Object ){builtin.__doc__=docs[key]}}
;
